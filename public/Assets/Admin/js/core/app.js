...
(function (window, document, $) {
	...
	$(window).on("load", function () {
		...
		$(".char-textarea1").on("keyup", function (event) {
			checkTextAreaMaxLength1(this, event);
			// to later change text color in dark layout
			$(this).addClass("active");
		});
		$(".char-textarea2").on("keyup", function (event) {
			checkTextAreaMaxLength2(this, event);
			// to later change text color in dark layout
			$(this).addClass("active");
		});
		$(".char-textarea3").on("keyup", function (event) {
			checkTextAreaMaxLength3(this, event);
			// to later change text color in dark layout
			$(this).addClass("active");
		});
		$(".char-textarea4").on("keyup", function (event) {
			checkTextAreaMaxLength4(this, event);
			// to later change text color in dark layout
			$(this).addClass("active");
		});
		$(".char-textarea5").on("keyup", function (event) {
			checkTextAreaMaxLength5(this, event);
			// to later change text color in dark layout
			$(this).addClass("active");
		});
		$(".char-textarea6").on("keyup", function (event) {
			checkTextAreaMaxLength6(this, event);
			// to later change text color in dark layout
			$(this).addClass("active");
		});
		...
		*/
		...
		function checkTextAreaMaxLength1(textBox, e) {
			...
			$(".char-count1").html(textBox.value.length);

			if (textBox.value.length > maxLength) {
				$(".counter-value1").css("background-color", $danger);
				$(".char-textarea1").css("color", $danger);
				// to change text color after limit is maxedout out
				$(".char-textarea1").addClass("max-limit");
			} else {
				$(".counter-value1").css("background-color", $primary);
				$(".char-textarea1").css("color", $textcolor);
				$(".char-textarea1").removeClass("max-limit");
			}
		...
		function checkTextAreaMaxLength2(textBox, e) {
			...
			$(".char-count2").html(textBox.value.length);

			if (textBox.value.length > maxLength) {
				$(".counter-value2").css("background-color", $danger);
				$(".char-textarea2").css("color", $danger);
				// to change text color after limit is maxedout out
				$(".char-textarea2").addClass("max-limit");
			} else {
				$(".counter-value2").css("background-color", $primary);
		...
		function checkTextAreaMaxLength3(textBox, e) {
			var maxLength = parseInt($(textBox).data("length"));
			...
			$(".char-count3").html(textBox.value.length);

			if (textBox.value.length > maxLength) {
				$(".counter-value3").css("background-color", $danger);
				$(".char-textarea3").css("color", $danger);
				// to change text color after limit is maxedout out
				$(".char-textarea3").addClass("max-limit");
			} else {
				$(".counter-value3").css("background-color", $primary);
				$(".char-textarea3").css("color", $textcolor);
				$(".char-textarea3").removeClass("max-limit");
			}

			return true;
		}
		function checkTextAreaMaxLength4(textBox, e) {
			var maxLength = parseInt($(textBox).data("length"));
			...
			$(".char-count4").html(textBox.value.length);

			if (textBox.value.length > maxLength) {
				$(".counter-value4").css("background-color", $danger);
				$(".char-textarea4").css("color", $danger);
				// to change text color after limit is maxedout out
				$(".char-textarea4").addClass("max-limit");
			} else {
				$(".counter-value4").css("background-color", $primary);
				$(".char-textarea4").css("color", $textcolor);
				$(".char-textarea4").removeClass("max-limit");
			}

			return true;
		}
		function checkTextAreaMaxLength5(textBox, e) {
			var maxLength = parseInt($(textBox).data("length"));
			...
			$(".char-count5").html(textBox.value.length);

			if (textBox.value.length > maxLength) {
				$(".counter-value5").css("background-color", $danger);
				$(".char-textarea5").css("color", $danger);
				// to change text color after limit is maxedout out
				$(".char-textarea5").addClass("max-limit");
			} else {
				$(".counter-value5").css("background-color", $primary);
				$(".char-textarea5").css("color", $textcolor);
				$(".char-textarea5").removeClass("max-limit");
			}

			return true;
		}
		function checkTextAreaMaxLength6(textBox, e) {
			var maxLength = parseInt($(textBox).data("length"));
			...
			$(".char-count6").html(textBox.value.length);

			if (textBox.value.length > maxLength) {
				$(".counter-value6").css("background-color", $danger);
				$(".char-textarea6").css("color", $danger);
				// to change text color after limit is maxedout out
				$(".char-textarea6").addClass("max-limit");
			} else {
				$(".counter-value6").css("background-color", $primary);
				$(".char-textarea6").css("color", $textcolor);
				$(".char-textarea6").removeClass("max-limit");
			}
