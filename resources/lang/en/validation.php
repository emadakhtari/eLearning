...
return [
    ...
    */
    ...
    'url' => 'فرمت آدرس لینک اشتباه است.',
    'recaptcha' => 'فرمت تصوریر :attribute اشتباه است.',
    'captcha' => 'فرمت تصوریر :attribute اشتباه است.',
    ...
    */
    ...
    'custom' => [
        'url' => [
            'required_if' => 'در صورتی که نوع نمایش آدرس سایت می باشد باید آدرس سایت را وارد نمایید'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'identity' => 'نوع شرکت',
        'legal_character' => 'شرکت حقوقی',
        'company_name' => 'نام شرکت',
        'real_character' => 'شرکت حقیقی',
        'link' => 'لینک سایت',
        'user_id' => 'نام کاربری',
        'count' => 'تعداد',
        'tag' => 'برچسب',
        'file' => 'فایل مربوطه باید',
        'publicName' => 'نام نمایشی',
        'user_category_id' => 'گروهبندی کاربران',
        'code' => 'کد اعتبار سنجی',
        'family' => 'نام خانوادگی',
        'item_id' => 'کد اپ',
        'imageicon' => 'تصویر',
        ...
        'category' => 'دسته بندی ',
        'app_category_id' => 'گروهبندی ',
        'isImportant' => 'تعیین وضعیت ',
        'app_id' => 'انتخاب اپلیکیشن',
        'versionCode' => 'کد ورژن',
        'versionName' => 'نام ورژن',
        'vitrine_id' => 'نام ویترین',
