...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item "><a>دروس</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row match-height">
                <div class="col-12 col-sm-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <form id="form" class="form form-vertical" name="form" method="post"
                          action="{{route('Lesson.Add')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach($grade as $item)
                                                            <option
                                                                @if(old('grade_id') == $item->id) selected @endif
    ...
    <input type="hidden" id="gradeCur" value="{{old('grade_id')}}">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function Lesson_table() {
                ...
                $.ajax({
                    ...
                    data: {grade_id: grade_id,baseIds: baseIds, _token: _token},
        ...
        $(function () {
            $("form#form").validate({
                ...
                messages: {
                    title: {
                        required: "لطفا دروس را وارد نمایید.",
                    },
                    grade_id: {
