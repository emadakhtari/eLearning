                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item "><a>ویرایش مدرس</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    @if(Auth::guard('teacher')->check() == true)
                        <form id="form" class="form form-vertical" name="form" method="post"
                              action="{{route('Teacher.Edit', [$data['id']])}}" enctype="multipart/form-data">
                            <input type="hidden" value="{{ csrf_token() }}" name="_token" id="_token">
                            <input type="hidden" value="{{ $data['id'] }}" name="teacher_id" id="teacher_id">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                data: {school_id: school_id, deputy_id: deputy_id, teacher_id: teacher_id, _token: _token},
