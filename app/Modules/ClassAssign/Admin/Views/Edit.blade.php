                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item "><a>ویرایش کلاس</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    @if($deputyAdmin->hasPermission('ClassAssign.Edit.View') || $deputyAdmin->level == "1")
                        <form id="form" class="form form-vertical" name="form" method="post"
                              action="{{route('ClassAssign.Edit', [$data['id']])}}" enctype="multipart/form-data">
                            <input type="hidden" value="{{ csrf_token() }}" name="_token" id="_token">
                            <input type="hidden" value="{{ $data['id'] }}" id="ClassId">
