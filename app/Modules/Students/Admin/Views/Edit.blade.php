...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item "><a>ویرایش دانش آموز</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    @if($deputyAdmin->hasPermission('Students.Edit.View') || $deputyAdmin->level == "1")
                        <form id="form" class="form form-vertical" name="form" method="post"
                              action="{{route('Students.Edit', [$data['id']])}}" enctype="multipart/form-data">
                            <input type="hidden" value="{{ csrf_token() }}" name="_token" id="_token">
                            <input type="hidden" value="{{ $data['id'] }}" name="student_id" id="student_id">
                            <input type="hidden" value="{{$deputyId}}" name="deputy_id" id="deputy_id">
                            <input type="hidden" value="{{$gradeSelect->id}}" name="grade_id" id="grade_id">
                            <input type="hidden" value="{{$SchoolSelect->id}}" name="school_id" id="school_id">
                            <input type="hidden" value="{{$data['class_id']}}" name="class_id_edit" id="class_id_edit">
                            <input type="hidden" value="{{$data['base_id']}}" name="base_id_edit" id="base_id_edit">
                            <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="uploadedImage" id="uploadedImage" value="{{$data['image']}}">
                                                        <div class="position-relative has-icon-left">
                                                            <fieldset>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    @if($data['image'])
                                                        <img class="studentImage" src="{{asset('upload/students/images/'.$data['image'])}}" alt="" style="width: 50%;border-radius: 30px">
                                                        <a href="#" class="btn btn-danger mr-1 mb-1 removeImage" rel="{{$data['id']}}">حذف</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative has-icon-left">
                                                            <input type="text" id="parents_national_code"
                                                                   ...
                                                                   value="{{$parentsSelect->national_code}}"
                                                                   readonly
                                                                   data-length="10"
                                                                   minlength="10" maxlength="10"
                                                                   placeholder="نام کاربری (کد ملی)"
    ...
    <input type="hidden" id="ClassCur" name="ClassCur" value="{{$data['class_id']}}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $(".removeImage").on("click", function () {
                swal({
                        title: "آیا از حذف این تصویر اطمینان دارید؟",
                        text: "پس از حذف قادر به بازیابی این تصویر نخواهید بود!",
                        type: "warning",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            var _id = $(".removeImage").attr("rel");
                            var _token = $("#_token").val();
                            $(".studentImage").remove();
                            $(".removeImage").remove();
                            $(".custom-file-label").text('انتخاب فایل');
                            $("#uploadedImage").val('');
                            swal("", "تصویر شما حذف شد.", "success");
                            $.ajax({
                                type: "POST",
                                url: "{{route('StudentsManager.DeleteImage')}}",
                                data: {
                                    _id: _id,
                                    _token: _token
                                },
                            ...
                            swal("", "تصویر شما در امان است!", "error");
                        }
                    });
                return false;
            });
